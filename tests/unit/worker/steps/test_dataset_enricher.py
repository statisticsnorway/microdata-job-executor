...
def test_convert_from_csv_to_enriched_csv():
    ...
    assert lines[0] == ("11111111501853;22048613;1972;730;1095\n")
    assert lines[1] == ("11111111983265;1306729;1972;730;1095\n")
    assert lines[2] == ("11111111864482;21529182;2017;17167;17531\n")
...
def test_convert_from_csv_no_start_date_to_enriched_csv():
    ...
    lines = file.readlines()
    assert lines[0] == ("11111111501853;22048613;1972;730;1095\n")
    assert lines[1] == ("11111111983265;1306729;;;1095\n")
    assert lines[2] == ("11111111864482;21529182;2017;17167;17531\n")
    assert lines[3] == ("11111111719226;21529182;;;1095\n")
...
def test_convert_from_csv_no_stop_date_to_enriched_csv():
    ...
    lines = file.readlines()
    assert lines[0] == ("11111111501853;22048613;1972;730;1095\n")
    assert lines[1] == ("11111111983265;1306729;1972;730;\n")
    assert lines[2] == ("11111111864482;21529182;2017;17167;17531\n")
    assert lines[3] == ("11111111719226;21529182;2017;17167;\n")
...
def test_convert_from_csv_with_instant_to_enriched_csv():
    ...
    file = open(enriched_csv_file_path, "r", encoding="utf-8")
    lines = file.readlines()
    assert lines[0] == ("11111111501853;9;1972;730;1095\n")
    assert lines[1] == ("11111111983265;10;1972;730;1095\n")
    assert lines[2] == ("11111111864482;;2017;17167;17531\n")
